...
@section('titulo', 'Creando Habilidad')
@section('main')

    <br>
    <br>

    <form method="post" action="{{ action([\App\Http\Controllers\HabilidadController::class, 'store']) }}">
        @csrf
        ...
        <label>Porcentaje</label> <input type="number" name="porcentaje"> <br>
